...
def getBestPlantForRainfall(ashPlantain, brinjal, cucumber, ladiesFinger, redPumpkin):
    bestPlant = numpy.amax([ashPlantain, brinjal, cucumber, ladiesFinger, redPumpkin])
    ashPlantainRainfallPoints = (rainfallPoints(0.001, 0.003, rainfallPrevYearMaximum)[1]) + (rainfallPoints(0.001, 0.003, rainfallPrevYearMaximum)[2])
    brinjalRainfallPoints = (rainfallPoints(0.001, 0.003, rainfallPrevYearMaximum)[1]) + (rainfallPoints(0.001, 0.003, rainfallPrevYearMaximum)[2])
    cucumberRainfallPoints = (rainfallPoints(0.001, 0.003, rainfallPrevYearMaximum)[1]) + (rainfallPoints(0.001, 0.003, rainfallPrevYearMaximum)[2])
    ladiesFingerRainfallPoints = (rainfallPoints(0.001, 0.003, rainfallPrevYearMaximum)[1]) + (rainfallPoints(0.001, 0.003, rainfallPrevYearMaximum)[2])
    redPumpkinRainfallPoints = (rainfallPoints(0.001, 0.003, rainfallPrevYearMaximum)[1]) + (rainfallPoints(0.001, 0.003, rainfallPrevYearMaximum)[2])
    if bestPlant == ashPlantain:
        ...
        errorResult = "Ladies Finger had values exceeding the limits for " + str(ladiesFingerRainfallPoints) + " days"
    elif bestPlant == redPumpkin:
...
def getBestPlantForTemperature(ashPlantain, brinjal, cucumber, ladiesFinger, redPumpkin):
    ...
    if bestPlant == ashPlantain:
        ...
        errorResult = "Ash Plantain had values exceeding the limits for " + str(ashPlantainTemperaturePoints) + " days"
    elif bestPlant == brinjal:
        ...
        errorResult = "Ladies Finger had values exceeding the limits for " + str(ladiesFingerTemperaturePoints) + " days"
    elif bestPlant == redPumpkin:
        plantResult = "Plant with Highest Number Points for Temperature is Red Pumpkin"
        errorResult = "Red Pumpkin had values exceeding the limits for " + str(redPumpkinTemperaturePoints) + " days"
    return plantResult, errorResult
...
print("Ladies Fingers Price Points           : ", pricePoints(ladiesFingerPrevYearPrices, ladiesFingersMPriceArray)[0])
...
marketPriceBest = getBestPlantForMarketPrice(ashPlantainPricePoints, brinjalPricePoints, cucumberPricePoints, ladiesFingerPricePoints, redPumpkinPricePoints)
marketPriceBestWeekPlant = getOutputStringAsJsonMarketPrice(ashPlantainPriceWeek, brinjalPriceWeek, cucumberPriceWeek, ladiesFingerPriceWeek, redPumpkinPriceWeek)
...
temperatureBest = getBestPlantForTemperature(ashPlantainTemperaturePoints, brinjalTemperaturePoints, cucumberTemperaturePoints, ladiesFingerTemperaturePoints, redPumpkinTemperaturePoints)[0]
temperatureBestDays = getBestPlantForTemperature(ashPlantainTemperaturePoints, brinjalTemperaturePoints, cucumberTemperaturePoints, ladiesFingerTemperaturePoints, redPumpkinTemperaturePoints)[1]
...
rainfallBest = getBestPlantForRainfall(ashPlantainRainfallPoints, brinjalRainfallPoints, cucumberRainfallPoints, ladiesFingerRainfallPoints, redPumpkinRainfallPoints)[0]
rainfallBestDays = getBestPlantForRainfall(ashPlantainRainfallPoints, brinjalRainfallPoints, cucumberRainfallPoints, ladiesFingerRainfallPoints, redPumpkinRainfallPoints)[1]

print("-----------------------------------------------------------")

print("Ash Plantain Cultivated Area Points   : ", cultivatedAreaPoints(cultivatedAreaAshPlantain, cultivatedAreaBrinjal, cultivatedAreaCucumber, cultivatedAreaLadiesFinger, cultivatedAreaPumpkin)[0])
ashPlantainCultivatedAreaPoints = cultivatedAreaPoints(cultivatedAreaAshPlantain, cultivatedAreaBrinjal, cultivatedAreaCucumber, cultivatedAreaLadiesFinger, cultivatedAreaPumpkin)[0]
print("Brinjal Cultivated Area Points        : ", cultivatedAreaPoints(cultivatedAreaAshPlantain, cultivatedAreaBrinjal, cultivatedAreaCucumber, cultivatedAreaLadiesFinger, cultivatedAreaPumpkin)[1])
brinjalCultivatedAreaPoints = cultivatedAreaPoints(cultivatedAreaAshPlantain, cultivatedAreaBrinjal, cultivatedAreaCucumber, cultivatedAreaLadiesFinger, cultivatedAreaPumpkin)[1]
print("Cucumber Cultivated Area Points       : ", cultivatedAreaPoints(cultivatedAreaAshPlantain, cultivatedAreaBrinjal, cultivatedAreaCucumber, cultivatedAreaLadiesFinger, cultivatedAreaPumpkin)[2])
cucumberCultivatedAreaPoints = cultivatedAreaPoints(cultivatedAreaAshPlantain, cultivatedAreaBrinjal, cultivatedAreaCucumber, cultivatedAreaLadiesFinger, cultivatedAreaPumpkin)[2]
print("Ladies Fingers Cultivated Area Points : ", cultivatedAreaPoints(cultivatedAreaAshPlantain, cultivatedAreaBrinjal, cultivatedAreaCucumber, cultivatedAreaLadiesFinger, cultivatedAreaPumpkin)[3])
ladiesFingerCultivatedAreaPoints = cultivatedAreaPoints(cultivatedAreaAshPlantain, cultivatedAreaBrinjal, cultivatedAreaCucumber, cultivatedAreaLadiesFinger, cultivatedAreaPumpkin)[3]
print("Red Pumpkin Cultivated Area Points    : ", cultivatedAreaPoints(cultivatedAreaAshPlantain, cultivatedAreaBrinjal, cultivatedAreaCucumber, cultivatedAreaLadiesFinger, cultivatedAreaPumpkin)[4])
redPumpkinCultivatedAreaPoints = cultivatedAreaPoints(cultivatedAreaAshPlantain, cultivatedAreaBrinjal, cultivatedAreaCucumber, cultivatedAreaLadiesFinger, cultivatedAreaPumpkin)[4]
bestCultivatedPlant = getBestPlantCultivatedAreaWise(ashPlantainCultivatedAreaPoints, brinjalCultivatedAreaPoints, cucumberCultivatedAreaPoints, ladiesFingerCultivatedAreaPoints, redPumpkinCultivatedAreaPoints)

print("-----------------------------------------------------------")

AshPlantainPoints = ((ashPlantainPricePoints + ashPlantainTemperaturePoints + ashPlantainRainfallPoints + ashPlantainCultivatedAreaPoints) / 400) * 100
print("Ash Plantain Total Points             : ", AshPlantainPoints)
BrinjalPoints = ((brinjalPricePoints + brinjalTemperaturePoints + brinjalRainfallPoints + brinjalCultivatedAreaPoints) / 400) * 100
print("Brinjal Total Points                  : ", BrinjalPoints)
CucumberPoints = ((cucumberPricePoints + cucumberTemperaturePoints + cucumberRainfallPoints + cucumberCultivatedAreaPoints) / 400) * 100
print("Cucumber Total Points                 : ", CucumberPoints)
LadiesFingerPoints = ((ladiesFingerPricePoints + ladiesFingerTemperaturePoints + ladiesFingerRainfallPoints + ladiesFingerCultivatedAreaPoints) / 400) * 100
print("Ladies Finger Total Points            : ", LadiesFingerPoints)
RedPumpkinPoints = ((redPumpkinPricePoints + redPumpkinTemperaturePoints + redPumpkinRainfallPoints + redPumpkinCultivatedAreaPoints) / 400) * 100
...
print(json.dumps(pointsString, indent=2))
