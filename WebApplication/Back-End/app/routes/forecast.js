...
cron.schedule("30 23 * * Monday", async (req, res) => {
  ...
  try {
    ...
    const autoarimaTempForecast = await axios.get(
      "https://agrobuddy-models.an.r.appspot.com/forecast?model=auto_arima&type=temp"
    );
    const autoarimaTemp = JSON.stringify(autoarimaTempForecast.data);

    const autoarimaRaiFallForecast = await axios.get(
      "https://agrobuddy-models.an.r.appspot.com/forecast?model=auto_arima&type=rain"
    );
    const autoarimaRaiFall = JSON.stringify(autoarimaRaiFallForecast.data);

    const autoarimaAshPlantainForecast = await axios.get(
      "https://agrobuddy-models.an.r.appspot.com/forecast?model=auto_arima&type=market&plant=AshPlantain"
    );
    ...
    const autoarimaBrinjalForecast = await axios.get(
      "https://agrobuddy-models.an.r.appspot.com/forecast?model=auto_arima&type=market&plant=Brinjal"
    );
    const autoarimaBrinjal = JSON.stringify(autoarimaBrinjalForecast.data);

    const autoarimaCucumberForecast = await axios.get(
      "https://agrobuddy-models.an.r.appspot.com/forecast?model=auto_arima&type=market&plant=Cucumber"
    );
    ...
    const autoarimaladiesFingersForecast = await axios.get(
      "https://agrobuddy-models.an.r.appspot.com/forecast?model=auto_arima&type=market&plant=LadiesFinger"
    );
    ...
    const autoarimaRedPumpkinForecast = await axios.get(
      "https://agrobuddy-models.an.r.appspot.com/forecast?model=auto_arima&type=market&plant=RedPumpkin"
    );
    ...
    const sarimaRedPumpkinForecast = await axios.get(
      "https://agrobuddy-models.an.r.appspot.com/forecast?model=sarima&type=market&plant=RedPumpkin"
    );
